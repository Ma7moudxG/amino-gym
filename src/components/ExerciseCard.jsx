...
export default function ExerciseCard(props) {
  ...
  return (
    <div className="p-4 rounded-md flex flex-col gap-4 
        ...
        <div className="flex flex-col sm:flex-row sm:items-cener 
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2">
            ...
            <button onClick={handleSetIncrement} className="flex flex-col p-2 border-[1.5px] 
            duration-200 border-solid border-yellow-900 
            hover:border-yellow-600 w-full">
